    ...
    return (
        <section className="py-20">
            <div className="flex items-center gap-3 mb-12">
               ...
               <h2 className="text-xl font-black text-white italic uppercase tracking-tighter">Linha do Tempo</h2>
            </div>
                ...
                {milestones.map((item, idx) => (
                    ...
                    >
                        ...
                        <div className="flex flex-col md:flex-row md:items-baseline gap-2 md:gap-6">
                            <span className="text-2xl font-black text-white italic shrink-0">{item.year}</span>
                            <div className="glass-card p-6 rounded-[32px] border-white/5 bg-[#1E1E1E]/40 w-full hover:bg-white/5 transition-colors">
