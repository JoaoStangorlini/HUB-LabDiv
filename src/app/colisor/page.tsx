...
const wikiCategories = [
    {
        ...
        icon: 'auto_stories',
        links: [
            { name: 'O que são Trilhas?', href: '/manual#trilhas' },
    ...
    },
    {
        ...
        icon: 'menu_book',
        links: [
            { name: 'Manual de Envio', href: '/manual' },
            { name: 'Direitos Autorais', href: '/manual' },
            { name: 'Formatos Suportados', href: '/manual#formatos' }
        ]
    },
    {
            ...
            <div className="py-12 max-w-4xl mx-auto px-4">
                ...
                <div className="mb-12 text-center md:text-left">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-lg max-w-2xl leading-relaxed">
                        O repositório técnico de conhecimento estruturado do Instituto de Física. Explore o emaranhamento entre guias, artigos técnicos e laboratórios.
                    </p>
                </div>
