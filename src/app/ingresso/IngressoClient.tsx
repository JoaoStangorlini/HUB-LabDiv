    ...
    return (
        <div className="space-y-16 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            <header className="max-w-3xl mx-auto text-center space-y-4">
                ...
                <h1 className="text-5xl md:text-6xl font-display font-black text-white uppercase tracking-tighter leading-none">
            ...
            <div className="glass-card rounded-[40px] border border-white/5 p-12 relative overflow-hidden group">
