                ...
                <div className="p-8 sm:p-12 relative">
                    ...
                    <div className="flex flex-col items-center text-center space-y-4 mb-10">
                        <div className="relative w-16 h-16 mb-4">
                            ...
                            <div className="absolute w-10 h-12 bg-brand-red rounded-[1px] bottom-0 right-0 z-0 translate-y-1"></div>
                            <div className="absolute w-10 h-10 bg-brand-yellow rounded-full top-4 left-4 z-20 shadow-sm border-2 border-white dark:border-transparent"></div>
                        </div>
                    ...
                    <div className="space-y-4">
                        <button
                            ...
                            disabled={isLoading}
                            className="w-full flex items-center justify-center gap-4 bg-white dark:bg-card-dark hover:bg-gray-50 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-200 border-2 border-gray-100 dark:border-gray-800 py-4 px-6 rounded-2xl font-bold transition-all transform hover:-translate-y-1 active:scale-[0.98] shadow-sm disabled:opacity-50 disabled:cursor-not-allowed group"
                        >
                            {isLoading ? (
